...
function Home() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Visualiza relaciones y patrones de interacción entre políticos usando grafos de conocimiento.',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: 'Analisis de Comisiones',
      description: 'Explora transcripciones de sesiones. Obtén briefings, analiza posiciones y encuentra citas usando IA.',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-slate-400 mb-10 max-w-2xl mx-auto">
              Predice votaciones, visualiza redes políticas y analiza transcripciones
              de comisiones usando tecnología de vanguardia.
            </p>

            {/* CTAs */}
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/predictor" className="btn-primary inline-flex items-center justify-center">
                Comenzar Demo
