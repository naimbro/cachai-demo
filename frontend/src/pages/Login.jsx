...
function Login() {
  ...
  return (
    <div className="min-h-screen bg-dark-900 flex flex-col items-center justify-center px-4">
      ...
      <div className="relative z-10 glass-card p-8 sm:p-12 max-w-md w-full text-center">
        {/* Logo */}
        <img
          src={logoImg}
          alt="CachAI"
        ...
        <p className="text-slate-400 mb-8">
          Inicia sesion para acceder a la plataforma
        </p>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-white text-gray-800
                     font-medium py-3 px-4 rounded-xl hover:bg-gray-100 transition-colors
        ...
        >
          ...
          <span>{isSigningIn ? 'Iniciando sesion...' : 'Continuar con Google'}</span>
        </button>
